                        ...
                        <div className="bg-white w-full max-w-lg rounded-2xl shadow-2xl pointer-events-auto flex flex-col max-h-[90vh]">
                            ...
                            <form onSubmit={handleSubmit} className="p-6 space-y-4 overflow-y-auto">
                                <div>
                                    ...
                                    <input type="text" value={title} onChange={e => setTitle(e.target.value)} className="w-full px-4 py-2 border rounded-xl focus:ring-2 focus:ring-violet-500/20 outline-none" required />
                                </div>
                                <div>
                                    <label className="block text-sm font-semibold text-slate-700 mb-1">Department</label>
                                    <select value={dept} onChange={e => setDept(e.target.value)} className="w-full px-4 py-2 border rounded-xl focus:ring-2 focus:ring-violet-500/20 outline-none" required>
                                ...
                                <div>
                                    ...
                                    <textarea value={desc} onChange={e => setDesc(e.target.value)} rows="4" className="w-full px-4 py-2 border rounded-xl focus:ring-2 focus:ring-violet-500/20 outline-none resize-none" required />
                                </div>
